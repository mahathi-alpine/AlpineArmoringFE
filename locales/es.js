export default {
  ...
  armoredRental: '/alquiler-blindados',
  ...
  ballisticChartTitle: 'Tabla balística',
  ...
  footerPickupTrucksTitle: 'Blindaje de camionetas',
  footerPreOwnedTitle: 'Vehículos blindados de segunda mano',
  footerLawEnforcementTitle: 'Blindaje de vehículos para fuerzas del orden',
  footerSuvsTitle: 'Blindaje de SUVs',
  footerVansTitle: 'Blindaje de furgonetas y autobuses',
  footerSedansTitle: 'Blindaje de sedanes',
  footerCitTitle: 'Blindaje de vehículos de transporte de valores',
