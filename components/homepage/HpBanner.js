    ...
    <div className={`${styles.hp_banner}`}>
      <div className={`${styles.hp_banner_inner}`}>
        ...
        <div className={`${styles.hp_banner_content}`}>
          <h2 className={`${styles.hp_banner_subtitle} animate fade-in-up desktop-only`}>{props.subtitle}</h2>        
          <h1 className={`${styles.hp_banner_title} delay-3 animate fade-in-up`}>{props.title}</h1>
          <div class="delay-8 animate fade-in-scale inline-block">
